...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg">
      <div class="container">
        <a id="logo-name" class="navbar-brand" href="#"> Thesis Archives </a>
        <button
    ...
    <section class="home">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="text">Virtual Thesis Repository <spann class="text2">An Online Archive System</spann></div>
          </div>
    ...
    <section class="setup">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#93BFCF" fill-opacity="1" d="M0,288L48,272C96,256,192,224,288,186.7C384,149,480,107,576,101.3C672,96,768,128,864,170.7C960,213,1056,267,1152,282.7C1248,299,1344,277,1392,266.7L1440,256L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path></svg>
      <div class="container">
        ...
        <div class="row info-1">
          ...
          <div class="col-md-6">
            <div class="text-information">
              <h5>Can Easily Manage File upload and Download</h5>
              <p>
                ...
                <div class="col-md-6">
                    <div class="row row-cols-1 row-cols-lg-5 g-2 g-lg-3">
                        ...
                        <div class="col-md-3">
                            <div>
                                <small>
                                    <a href="#" class="text-decoration-none">Hays</a>
                                </small>
                            </div>
                        </div>
                        <div class="col-md-3">
