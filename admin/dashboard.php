...
<body>
      ...
      <div class="py-4">
        ...
        <div class="row g-3">
          <div class="col-12 col-sm-6 col-lg-3">
            <a href="manage_students.php" class="text-dark text-decoration-none bg-white p-3 rounded shadow-sm d-flex justify-content-between summary-primary">
              <div>
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <a href="manage_groups.php" class="text-dark text-decoration-none bg-white p-3 rounded shadow-sm d-flex justify-content-between summary-primary">
              <div>
                <i class="ri-group-2-line summary-icon bg-warning mb-2"></i>
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <a href="manage_faculty.php" class="text-dark text-decoration-none bg-white p-3 rounded shadow-sm d-flex justify-content-between summary-indigo">
              <div>
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <a href="archives.php" class="text-dark text-decoration-none bg-white p-3 rounded shadow-sm d-flex justify-content-between summary-info">
              <div>
                <i class="ri-archive-drawer-line summary-icon bg-info mb-2"></i>
                <div>Total Archives</div>
              </div>
              <h4><?php
                  require '../class/dbconfig.php';
                  $query = "SELECT id FROM proposed_titles WHERE status = 'Archived' ORDER BY id";
                  $query_run = mysqli_query($conn, $query);
                  $row = mysqli_num_rows($query_run);
                  $total_archives = intval($row);
                  echo $row;

                  $array = array();
                  array_push($array, $total_student, $total_faculty, $total_archives, $total_groups  );
                ?>
              </h4>
            </a>
          </div>
  ...
  <script>
    $(document).ready(function() {
      const dataChart = <?php echo json_encode($array) ?>;
