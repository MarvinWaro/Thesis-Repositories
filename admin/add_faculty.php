    ...
    <div class="p-2">
      ...
      <div class="py-4">
        ...
        <div class="main-content border">
          <div class="form-cont">
            <form class="edit-form" action="add_faculty.php" method="post">
              ...
              <div class="cont">
                ...
                <input class="form-input me-2" type="text" id="firstname" name="firstname" placeholder="Enter First name*" value="<?php if (isset($_POST['firstname'])) {
              ...
              <div class="cont">
                ...
                <input class="form-input me-2" type="text" id="lastname" name="lastname" placeholder="Enter Last name*" value="<?php if (isset($_POST['lastname'])) {
                                                                                                                                  echo $_POST['lastname'];
                                                                                                                                } ?>">
              ...
              <div class="cont">
                ...
                <input class="form-input me-2" type="email" id="email" name="email" placeholder="Enter Email*" required value="<?php if (isset($_POST['email'])) {
                                                                                                                                  echo $_POST['email'];
                                                                                                                                } ?>">
              ...
              <div class="cont">
                ...
                <select name="department" id="department">
                  <option value="None" <?php if (isset($_POST['department'])) {
                                          if ($_POST['department'] == 'None') echo ' selected="selected"';
                                        } ?>>--Select Department.--</option>
                  <option value="Computer Science" <?php if (isset($_POST['department'])) {
                                                      if ($_POST['department'] == 'Computer Science') echo ' selected="selected"';
                                                    } ?>>Computer Science</option>
                  <option value="Information Technolgy" <?php if (isset($_POST['department'])) {
                                                          if ($_POST['department'] == 'Information Technology') echo ' selected="selected"';
